...
export class HomeComponent {
  ...
  tasks = [
    new SingleTask('020', '020 - Location Tracking', 'Concept past trip journal for a ride sharing service', '../images/020.png'),
    ...
    new SingleTask('016', '016 - Pop up/Overlay', 'Pop up subscription dialog for a food delivery service', '../images/016.png'),
    new SingleTask('015', '015 - On/off switch', 'Take on digital an on/off light switch', '../images/015.gif'),
    new SingleTask('014', '014 - Countdown', 'Material Breathing animation countdown, designed as a yoga app, where the countdown is the remaining duration of the pose', '../images/014.gif'),
    new SingleTask('013', '013 - Direct Messaging', 'A concept of what a Material Design messaging app might look like for desktop', '../images/013.png'),
    new SingleTask('012', '012 - Single Product', 'Single product concept page for the new Nike Vapormax', '../images/012.png'),
    ...
    new SingleTask('009', '009 - Music Player', 'Revising the concept Music player from the Android Reimagined project in my Portfolio', '../images/009.png'),
    ...
    new SingleTask('004', '004 - Calculator', 'Concept calculator for Android OS using Material Design', '../images/004.png'),
    ...
    new SingleTask('001', '001 - Sign Up', 'A registration page for an app using my personal identity styling, focusing on the interaction and user experience of the registration form', '../images/001.GIF')
  ];
}
